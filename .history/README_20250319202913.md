...
3. Choose metrics to use in the dashboard. In my dashboard I selected Network Out Total Network In Total, 
...
### Set e the Correct Time Range and Time Granularity in the Dashboard

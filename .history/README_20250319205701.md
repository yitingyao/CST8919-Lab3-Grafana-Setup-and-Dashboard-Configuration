...
1. **Enable Managed Identity authentication in Grafana:**
   - Edit the Grafana configuration file:
     ...
     ```
   - Locate the `[azure]` section in the configuration file and configured authentication using Managed Identity by inserting line **managed_identity_enabled = true** into the file.  
